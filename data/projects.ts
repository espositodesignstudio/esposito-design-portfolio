...
export const PROJECTS: Project[] = [
  {
    ...
    slug: "aura",
    title: "AURA DESIGN",
    subtitle: "Landing page dal design moderno ed energico",
    ...
    year: "2024",
    description: "Aura Design nasce come progetto accademico: sviluppare una landing page one-page a partire da un concept assegnato dal docente, senza un cliente reale da soddisfare ma con la stessa cura riservata a un brief professionale. L'obiettivo era dimostrare capacità di sintesi visiva e struttura in un formato compatto.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Aura Design nasce come progetto accademico: sviluppare una landing page one-page a partire da un concept assegnato dal docente, senza un cliente reale da soddisfare ma con la stessa cura riservata a un brief professionale. L'obiettivo era dimostrare capacità di sintesi visiva e struttura in un formato compatto.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho scelto uno stile moderno e una palette colori energica, per dare al progetto un'identità capace di catturare l'attenzione fin dal primo scroll. Ogni sezione è stata pensata per guidare l'occhio in modo naturale verso la call to action finale.",
  ...
  },
  {
    ...
    year: "2026",
    description: "Un personal trainer con un logo ormai datato e trascurato mi ha chiesto di intervenire sulla sua identità. Insieme abbiamo scelto una direzione capace di trasmettere motivazione e determinazione, valori centrali nel suo metodo di lavoro.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un personal trainer con un logo ormai datato e trascurato mi ha chiesto di intervenire sulla sua identità. Insieme abbiamo scelto una direzione capace di trasmettere motivazione e determinazione, valori centrali nel suo metodo di lavoro.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un pittogramma che rappresenta il percorso di crescita e la motivazione vissuti durante il lavoro con il personal trainer. La scelta cromatica rinforza il senso di energia e progressione.",
  ...
  },
  {
    ...
    year: "2024",
    description: "Un progetto personale nato per fare esperienza sul campo, con un concept fittizio: un brand di pasta biologica. Ho affrontato l'intero processo, dal naming al packaging, come farei con un cliente reale.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un progetto personale nato per fare esperienza sul campo, con un concept fittizio: un brand di pasta biologica. Ho affrontato l'intero processo, dal naming al packaging, come farei con un cliente reale.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un pittogramma che unisce i valori della natura (il grano, il sole, il biologico) che insieme formano, in negativo, la silhouette di una figura felice con le braccia alzate. Palette colori ispirata ai toni della natura.",
  ...
  },
  {
    ...
    subtitle: "Identità personale e sito portfolio, dal foglio al web",
    category: "Branding & UX/UI",
    ...
    year: "2025",
    description: "Un progetto a 360°: costruire la mia identità partendo da zero e tradurla in un portfolio coerente in ogni fase, dal logo all'esperienza utente. Ho affrontato l'intero processo come farei per un cliente esterno, definendo prima la strategia e poi l'esecuzione.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un progetto a 360°: costruire la mia identità partendo da zero e tradurla in un portfolio coerente in ogni fase, dal logo all'esperienza utente. Ho affrontato l'intero processo come farei per un cliente esterno, definendo prima la strategia e poi l'esecuzione.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho scelto uno stile creativo e handmade: il logo raffigura il mio volto disegnato a mano, con tratti volutamente irregolari, per trasmettere autenticità fin dal primo sguardo. Questa scelta si riflette anche nel sito, dove elementi illustrati accompagnano ogni sezione.",
  ...
  },
  {
    ...
    year: "2025",
    description: "Il concept di partenza univa due mondi apparentemente distanti: la birra artigianale e i tarocchi. Ho scelto la Ruota della Fortuna come simbolo centrale attorno a cui costruire l'intero progetto, dal naming al packaging.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Il concept di partenza univa due mondi apparentemente distanti: la birra artigianale e i tarocchi. Ho scelto la Ruota della Fortuna come simbolo centrale attorno a cui costruire l'intero progetto, dal naming al packaging.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un concept semplice e lineare, ispirato direttamente alla carta dei tarocchi, scegliendo font e palette colori capaci di evocare mistero e fortuna. Ogni elemento grafico richiama l'estetica esoterica del tema.",
    scope: ["Brand Strategy", "Logo Design", "Visual Identity", "Packaging Concept"],
    credits: [{ role: "Brand Designer", name: "Peppe Esposito" }],
    featured: true
  },
  {
    ...
    year: "2024",
    description: "Il mio primo progetto personale: lo sviluppo dell'identità completa per una squadra di calcio a 5, comprensiva di tutti gli asset necessari al club. Il cliente mi ha lasciato piena libertà creativa, permettendomi di costruire il brand da zero.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Il mio primo progetto personale: lo sviluppo dell'identità completa per una squadra di calcio a 5, comprensiva di tutti gli asset necessari al club. Il cliente mi ha lasciato piena libertà creativa, permettendomi di costruire il brand da zero.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
  ...
  },
  {
    ...
    slug: "gr-inox",
    title: "GR INOX",
    subtitle: "Rebranding tecnico per un'azienda di lavorazione dell'acciaio",
    category: "Branding & UX/UI",
    subCategory: "Brand Identity",
    ...
    year: "2026",
    description: "Un'azienda a conduzione familiare, guidata da due fratelli, con un'identità visiva ormai datata. Il brief chiedeva un ringiovanimento completo del brand, mantenendo al centro il legame tra i due fratelli e la lavorazione dell'acciaio, valore fondante dell'azienda.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un'azienda a conduzione familiare, guidata da due fratelli, con un'identità visiva ormai datata. Il brief chiedeva un ringiovanimento completo del brand, mantenendo al centro il legame tra i due fratelli e la lavorazione dell'acciaio, valore fondante dell'azienda.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un logotipo forte ed energico: le lettere G e R condividono un'asta con una legatura che richiama una giuntura saldata. Palette colori tecnica ed energica, abbinata a un font deciso che comunica solidità industriale.",
  ...
  },
  {
    ...
    cardTitle: "AM BARBER",
    subtitle: "Logo minimal per una barberia italiana",
    category: "Branding & UX/UI",
    subCategory: "Brand Identity",
    ...
    year: "2024",
    description: "Un progetto per un amico che stava per aprire il suo salone di barberia italiana. La richiesta era chiara: un logo che integrasse le sue iniziali, AM, mantenendo uno stile moderno e pulito, adatto a un pubblico contemporaneo.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un progetto per un amico che stava per aprire il suo salone di barberia italiana. La richiesta era chiara: un logo che integrasse le sue iniziali, AM, mantenendo uno stile moderno e pulito, adatto a un pubblico contemporaneo.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un logo minimal, integrando le iniziali del cliente in un pittogramma che richiama anche i lineamenti di un capello. Insieme al cliente abbiamo scelto una palette neutra, bianco e nero, per un'estetica senza tempo.",
  ...
  },
  {
    ...
    slug: "japan",
    title: "JAPAN",
    subtitle: "Sticker illustrati ispirati ai monumenti iconici del Giappone",
    category: "Branding & UX/UI",
    ...
    strategyDescription: "Uno dei miei progetti preferiti in assoluto. Nato come esercizio accademico (sviluppare un set di 3 sticker con relative declinazioni future), ho scelto come tema il Giappone, paese di cui sono da sempre appassionato, illustrando tre monumenti iconici: il Monte Fuji, il tempio Senso-ji e il portale Torii.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho disegnato gli sticker da zero su Procreate, per poi digitalizzarli su Illustrator, scegliendo una palette colori e uno stile dal sapore retro. Ogni sticker è stato pensato per funzionare anche come elemento decorativo indipendente.",
  ...
  },
  {
    ...
    year: "2026",
    description: "Un progetto sviluppato per un brand di candele artigianali, con totale libertà creativa lasciata dal cliente su stile e palette colori. Questa libertà mi ha permesso di esplorare un'estetica più delicata rispetto ai miei lavori abituali.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un progetto sviluppato per un brand di candele artigianali, con totale libertà creativa lasciata dal cliente su stile e palette colori. Questa libertà mi ha permesso di esplorare un'estetica più delicata rispetto ai miei lavori abituali.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
  ...
  },
  {
    ...
    year: "2024",
    description: "Un progetto realizzato per un caro amico, tra i più interessanti da sviluppare dal punto di vista creativo. L'ispirazione è nata da un dettaglio inaspettato: le pareti della mia stanza, punto di partenza per collegare visivamente il brand al materiale con cui lavora.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Un progetto realizzato per un caro amico, tra i più interessanti da sviluppare dal punto di vista creativo. L'ispirazione è nata da un dettaglio inaspettato: le pareti della mia stanza, punto di partenza per collegare visivamente il brand al materiale con cui lavora.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho sviluppato un'identità forte e tecnica, con una palette colori decisa capace di comunicare i valori del brand con immediatezza. Il logo riflette precisione e solidità, valori centrali per il settore edile.",
    scope: ["Brand Strategy", "Logo Design", "Visual Identity"],
    credits: [{ role: "Brand Designer", name: "Peppe Esposito" }],
    featured: true
  },
  {
    ...
    year: "2025",
    description: "Progetto accademico con un brief creativo: sviluppare l'identità per un festival di musica rap con line-up di tre artisti a scelta libera. Ho selezionato artisti che ascolto quotidianamente, per lavorare su un brief sentito e autentico.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Progetto accademico con un brief creativo: sviluppare l'identità per un festival di musica rap con line-up di tre artisti a scelta libera. Ho selezionato artisti che ascolto quotidianamente, per lavorare su un brief sentito e autentico.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho costruito un'identità dallo stile forte, capace di richiamare le atmosfere della musica di strada e della cultura rap. Tipografia decisa e texture urbane definiscono il carattere visivo del festival.",
    scope: ["Brand Strategy", "Logo Design", "Visual Identity"],
    credits: [{ role: "Brand Designer", name: "Peppe Esposito" }],
    featured: true
  },
  {
    ...
    year: "2025",
    description: "Progetto accademico focalizzato esclusivamente sulla progettazione digitale: sviluppare un sito multipagina per un museo di arte contemporanea, senza intervenire sull'identità visiva del brand già esistente. La sfida principale è stata bilanciare navigazione ed effetto immersivo.",
    strategyTitle: "IL PROGETTO & LA STRATEGIA",
    strategyDescription: "Progetto accademico focalizzato esclusivamente sulla progettazione digitale: sviluppare un sito multipagina per un museo di arte contemporanea, senza intervenire sull'identità visiva del brand già esistente. La sfida principale è stata bilanciare navigazione ed effetto immersivo.",
    visualDirectionTitle: "DIREZIONE VISIVA & SVILUPPO CONCETTUALE",
    visualDirectionDescription: "Ho costruito un'esperienza dinamica e immersiva, con una palette colori fredda scelta in coerenza con l'identità complessiva del sito. Transizioni e micro-interazioni accompagnano l'utente lungo il percorso espositivo digitale.",
